...
*/
import anchorImage from './components/rr-anchor-cream.png';
  ...
  return (
    <div className="relative min-h-screen bg-[#131313] text-[#F5F5F0]">
      ...
      <section className="relative pt-48 pb-32 px-6 md:px-12 max-w-7xl mx-auto flex flex-col items-center text-center overflow-hidden">
        <img src={anchorImage} alt="" className="absolute top-32 left-10 w-32 h-32 opacity-10 pointer-events-none select-none hidden md:block" />
        <motion.div
      ...
      <section id="about" className="py-32 bg-[#F5F5F0] text-[#131313] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none select-none opacity-[0.03]" style={{ backgroundImage: `url(${patternImage})`, backgroundSize: '400px' }} />
      ...
      <section className="py-32 bg-[#131313] text-[#F5F5F0] border-t border-[#F5F5F0]/5 relative overflow-hidden">
        <img src={verticalImage} alt="" className="absolute top-1/2 -translate-y-1/2 right-10 h-3/4 w-auto opacity-10 pointer-events-none select-none hidden lg:block" />
      ...
      <section id="resources" className="py-32 bg-[#131313] border-t border-[#F5F5F0]/5 relative overflow-hidden">
        <img src={plusImage} alt="" className="absolute bottom-10 left-20 w-32 h-32 opacity-10 pointer-events-none select-none hidden md:block" />
      ...
      <footer className="py-12 bg-[#131313] border-t border-[#F5F5F0]/5 relative overflow-hidden">
        <img src={horizontalImage} alt="" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl opacity-[0.02] pointer-events-none select-none" />
